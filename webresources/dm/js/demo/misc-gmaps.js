    ...
    markerMap.addMarker({
        ...
        click: function (e) {
            $.jasmineNoty({
                type: "info",
                icon: "fa fa-info",
                message: "ISSILOO Korean Center",
                container: 'floating',
                timer: 3500
            });
        },
        infoWindow: {
            content: '<div class="popover top" style="display:block; width:200px"><div class="arrow"></div><div class="popover-content"><strong>Bạn đang ở đây</strong><p>37 Hoa Hồng, p.2 Q.Phú Nhuận, HCM </p></div></div>',
