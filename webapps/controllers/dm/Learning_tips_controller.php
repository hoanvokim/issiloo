 ...
 * Time: 9:44 PM
 */
class Learning_tips_controller extends CI_Controller
{
    public $scheduleId = 46;
    ...
    public function index()
    {
        ...
        $data['title'] = 'Góc học tập';
        $this->load->view('pages/dm/learning_tips/view_all', $data);
    }

    public function create_learning_tips()
    {
        if (!$this->is_login()) {
            $this->load_login_view();
            return;
        ...
        $this->load->view('pages/dm/learning_tips/add', $data);
    }

    public function create_learning_tips_submit()
    {
        $insertId = -1;
        ...
        redirect('learning-tips-manager', 'refresh');
    }

    public function create_learning_tips_cancel()
    {
        redirect('learning-tips-manager', 'refresh');
    }

    public function update_learning_tips()
    {
        if (!$this->is_login()) {
            $this->load_login_view();
            return;
        ...
        $this->load->view('pages/dm/learning_tips/edit', $data);
    }

    public function update_learning_tips_submit()
    {
        if (isset($_POST["save"])) {
            $this->load->library('upload', $this->get_config());
            if ($this->upload->do_upload('userfile')) {
    ...
    public function update_learning_tips_cancel()
    {
        redirect('learning-tips-manager', 'refresh');
    }

    public function delete_learning_tips()
    {
