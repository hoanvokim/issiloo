<?php echo form_open_multipart('learning-tips-manager-create-learning-tips-submit'); ?>
...
<a href="<?php echo base_url() . "learning-tips-manager/create-learning-tips-cancel" ?>" type="submit"
