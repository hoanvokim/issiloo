<?php echo form_open_multipart('learning-tips-manager-update-learning-tips-submit'); ?>
...
<a href="<?php echo base_url() . "learning-tips-manager/update-learning-tips-cancel" ?>" type="submit" class="btn btn-default" onclick="return confirm('Bạn muốn thoát ra phải không?');" ><i
        class="fa fa-close"></i> Huỷ</a>
<a href="<?php echo base_url() . "learning-tips-manager/delete-learning-tips/" . $newsId; ?>"
