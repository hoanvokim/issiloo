...
<a href="<?php echo base_url() . "news-manager/update-news-cancel" ?>" type="submit" class="btn btn-default btn-xs" onclick="return confirm('Bạn muốn thoát ra phải không?');"><i
