<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title pull-left">Tất cả các bài viết của mục Tuyển dụng</h3>
        <a href="<?php echo base_url() . "recruitment-manager/create-recruitment" ?>"
        ...
        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <?php foreach ($programs as $program) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() . "recruitment-manager/update-recruitment/" . $program['id']; ?>"
                           class="btn btn-default btn-xs"><i class="fa fa-pencil-square"></i> Sửa</a>
                        <a href="<?php echo base_url() . "recruitment-manager/delete-recruitment/" . $program['id']; ?>"
