<?php echo form_open_multipart('recruitment-manager-update-recruitment-submit'); ?>
    ...
    <div class="tab-content">
        <div id="demo-lft-tab-1" class="tab-pane fade active in">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="demo-vs-definput" class="control-label">Đường dẫn trên thanh địa chỉ <span
                                    style="font-style: italic; font-size: 10px; padding-left: 10px;">(Xin vui lòng <span
                                        style="font-style: italic; font-size: 10px; color: red;"> không để trống</span> và nhập tiếng việt không dấu, và viết cách nhau bằng dấu "-" (ví dụ: chuong-trinh-du-hoc-issiloo))</span></label>
        ...
        <div id="demo-lft-tab-2" class="tab-pane fade">
            <div class="form-group">
                ...
                <br/>
                <textarea name="summaryeditor" class="form-control"
                          style="min-height: 300px;"><?php echo $visummary; ?></textarea>
            </div>
...
<button type="submit" class="btn btn-default" name="cancel" onclick="return confirm('Bạn muốn thoát ra phải không?');">
    <i class="fa fa-close"></i> Huỷ
</button>
<button type="submit" class="btn btn-danger pull-right" name="delete"
        onclick="return confirm('Bạn có muốn xoá không?');"><i class="fa fa-close"></i> Xoá
</button>
</form>