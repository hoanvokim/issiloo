<div class="panel">
    <div class="panel-heading">
        ...
        <a href="<?php echo base_url() . "study-manager/create_category" ?>"
    ...
    <div class="panel-body">
            ...
            <?php foreach ($categories as $category) { ?>
                <tr>
                    ...
                    <td class="demo-jasmine-btn">
                        <a href="<?php echo base_url() . "study-manager/add_child/" . $category['id']; ?>"
                           class="btn btn-mint btn-xs"><i class="fa fa-plus-square"></i> Thêm sub </a>
                        <a href="<?php echo base_url() . "study-manager/update_category/" . $category['id']; ?>"
                           class="btn btn-default btn-xs"><i class="fa fa-pencil-square"></i> Sửa</a>
                        <?php if (!empty($category['parent_id'])) { ?>
                            <a href="<?php echo base_url() . "study-manager/delete_category/" . $category['id']; ?>"
        ...
        <a href="<?php echo base_url() . "study-manager/create_category" ?>" class="btn btn-success pull-right btn-xs"><i class="fa fa-plus-square"></i> Thêm 1
            Phân Nhóm mới</a>
    </div>
</div>