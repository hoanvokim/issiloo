<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title pull-left">Tất cả các bài viết của Du học</h3>
        <a href="<?php echo base_url() . "news-manager/add-news" ?>"
        ...
        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <?php foreach ($news_list as $news) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() . "news-manager/update-study-news/" . $news['id']; ?>"
                           class="btn btn-default btn-xs"><i class="fa fa-pencil-square"></i> Sửa</a>
                        <a href="<?php echo base_url() . "news-manager/delete-study-news/" . $news['id']; ?>"
