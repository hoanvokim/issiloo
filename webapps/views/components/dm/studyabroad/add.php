<?php echo form_open_multipart('studyabroad-manager-create-studyabroad-submit'); ?>
...
<a href="<?php echo base_url() . "studyabroad-manager/create-studyabroad-cancel" ?>" type="submit" class="btn btn-default btn-xs" onclick="return confirm('Bạn muốn thoát ra phải không?');"><i
