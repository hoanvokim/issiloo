<?php echo form_open_multipart('studyabroad-manager-update-studyabroad-submit'); ?>
...
<a href="<?php echo base_url() . "studyabroad-manager/update-studyabroad-cancel" ?>" type="submit" class="btn btn-default" onclick="return confirm('Bạn muốn thoát ra phải không?');"><i
        class="fa fa-close"></i> Huỷ</a>
<a href="<?php echo base_url() . "studyabroad-manager/delete-studyabroad/" . $newsId; ?>"
