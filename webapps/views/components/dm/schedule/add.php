<?php echo form_open_multipart('schedule-manager-create-schedule-submit'); ?>
...
<a href="<?php echo base_url() . "schedule-manager/create-schedule-cancel" ?>" type="submit" class="btn btn-default btn-xs"><i
