    ...
    <div class="main-container">
                    ...
                    <div class="col-sm-12">
                        <ul class="recent-projects recent-projects-slider">
                            <?php foreach($sliders as $slider){ ?>
                                <li>
                                    <img src="<?php echo $slider['img_src']; ?>">
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                <div class="row service-layout">
                    <div class="col-md-4 col-sm-12">
                        <div>
                            ...
                            <div class="pull-right"><a class="btn btn-default btn-xs"><?php echo $this->lang->line('READ_MORE'); ?><i
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 text-center">
                                                <div class="project-img-box">
                                                    <img src="images/imac.png" alt="" class="imac-img"/>
                                                    <div class="imac-img-content projects-slides">

                                                        <?php foreach($university['gallery'] as $item){ ?>

                                                            <div><img src="<?php echo $item['img_src']; ?>" alt=""/></div>
                                                ...
                                                <div class="col-md-6 padding-top--large">
                                                    ...
                                                    <h4>Website -
                                                        <small><a href="http://www.KOGURYEO.com" target="_blank"><?php echo $university['url']; ?></a>
                                                        </small>
                                                    </h4>
                                                    <p><a href="#" class="btn btn-primary"><?php echo $this->lang->line('READ_DETAIL'); ?> <i
        ...
        <div class="news-inner-container">
            <div class="container">
                ...
                <div class="pull-right"><a class="btn btn-default btn-xs"><?php echo $this->lang->line('READ_MORE_NEWS'); ?> <i
                        class="ion ion-ios-arrow-thin-right"></i></a></div>
            </div>
        </div>
        <!-- inner container end -->
