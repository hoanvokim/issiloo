            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li>
                            <a href="<?php echo site_url('manage_news'); ?>">
                                <i class="fa fa-newspaper-o"></i>
                                <span class="menu-title">Tin Tức</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('manage_sharing'); ?>">
                                <i class="fa fa-share-alt"></i>
                                <span class="menu-title">Góc chia sẽ</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('manage_faq'); ?>">
                                <i class="fa fa-question-circle-o"></i>
                                <span class="menu-title">Hỏi đáp</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('manage_tag'); ?>">
                        ...
                        <li>
                            <a href="<?php echo site_url('add_category'); ?>">
                                <i class="fa fa-plus-circle"></i>
                                <span class="menu-title">Thêm Category</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('add_news'); ?>">
                                <i class="fa fa-plus-circle"></i>
                                <span class="menu-title">Viết bài mới</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('add_university'); ?>">
                                <i class="fa fa-plus-circle"></i>
                        ...
                        <li>
                            <a href="<?php echo site_url('add_program'); ?>">
                                <i class="fa fa-product-hunt"></i>
                                <span class="menu-title">Chương trình đào tạo</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('add_schedule'); ?>">
